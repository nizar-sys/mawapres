@extends('layouts.app')
@section('title', 'Ubah Data Stok Produk')

@section('title-header', 'Ubah Data Stok Produk')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('stocks.index') }}">Data Stok Produk</a></li>
    <li class="breadcrumb-item active">Ubah Data Stok Produk</li>
@endsection
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Ubah Data Stok Produk</h5>
                </div>
                <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('produk_id') is-invalid @enderror" id="produk_id"
                                        ...
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}" @selected(old('produk_id', $stock->produk_id))>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('warna_id') is-invalid @enderror" id="warna_id"
                                        ...
                                        @foreach ($colors as $color)
                                            <option value="{{ $color->id }}" @selected(old('warna_id', $stock->warna_id))>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('stok_minimum') is-invalid @enderror" id="stok_minimum"
                                        placeholder="Stok Minimum Produk" value="{{ old('stok_minimum', $stock->stok_minimum) }}" name="stok_minimum">
